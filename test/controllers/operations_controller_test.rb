...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { account_id: @operation.account_id, description: @operation.description, type: @operation.type, value: @operation.value }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { account_id: @operation.account_id, description: @operation.description, type: @operation.type, value: @operation.value }
    assert_redirected_to operation_path(assigns(:operation))
  end

...
(function() {
  ...
  ready = function() {
    var account_from, account_from_transfer, category, switch_visible, transfer;
    ...
    switch_visible = function(val) {
      switch (val) {
        case '1':
          category.hide();
          transfer.hide();
          account_from.show();
          return account_from_transfer.hide();
        case '2':
          category.hide();
          transfer.show();
          account_from.hide();
          return account_from_transfer.show();
        default:
          category.show();
          transfer.hide();
          account_from.show();
    ...
    $("#operation_type").change(function() {
      return switch_visible($(this).val());
    });
    return $('[data-behaviour~=datepicker]').pickadate({
      format: "yyyy-mm-dd",
      formatSubmit: "yyyy-mm-dd"
    });
  };
...
(function() {
  ...
  ready = function() {
    return $('[data-behaviour~=datepicker_range]').pickadate({
      format: "dd.mm.yyyy"
    });
  };
